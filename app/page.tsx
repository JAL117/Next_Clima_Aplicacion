  ...
  if (Object.keys(data).length === 0 && error === "") {
    content = (
      <div className="text-white text-center h-screen mt-[5rem]">
        <h2 className="text-3xl font-semibold mb-4">Bienvenido a otra aplicacion de clima</h2>
        <p className="text-xl">Ingrese el nombre de una ciudad para obtener el pronóstico del tiempo.</p>
      </div>
    );
  } else if (error !== "") {
    content = (
      ...
      <div className="bg-white/25 w-full rounded-lg flex flex-col h-screen">
        <div className="flex flex-col md:flex-row justify-between items-center p-12">
          ...
          <h1 className="mb-8 md:mb-0 order-1 text-white text-2xl py-2 px-4 rounded-xl italic font-bold">
           <TiWeatherCloudy size={30}/>Aplicacion del clima
          </h1>
        </div>
        {content}
      </div>
